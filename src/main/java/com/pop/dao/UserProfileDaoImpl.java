...
public class UserProfileDaoImpl implements UserProfileDao {
    ...
    public boolean isFollowing(String username, String followerUsername) {
        String sql = "SELECT EXISTS(SELECT * FROM Follows where username = ? and followerUsername = ?)";
        var exists = jt.queryForObject(sql, new Object[]{username, followerUsername}, Integer.class);
        return exists != 0;
    }
